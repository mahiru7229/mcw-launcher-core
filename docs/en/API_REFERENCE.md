...
> This 1.0.1-era snapshot is retained for migration context. v1.5.1 consumers must verify exports from the current `mcw_core` and `mcw_core.api` source included in this package.

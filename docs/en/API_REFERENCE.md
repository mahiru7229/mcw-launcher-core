...
> This 1.0.1-era snapshot is retained for migration context. v1.5.0 consumers must verify exports from the current `mcw_core` and `mcw_core.api` source included in this package.
...
Accounts, skins and account repository.  
Current compatibility implementation: `src/core/account/account_manager.py`
...
Accounts, skins and account repository.  
Current compatibility implementation: `src/core/account/account_skin_manager.py`
...
Current compatibility implementation: `src/core/auth/microsoft/microsoft_auth_gate.py`

#### `MicrosoftAuthenticationLockedError`
- Exception/data class; inspect attributes in source or typed exception handler.
...
Microsoft/OAuth authentication.  
Current compatibility implementation: `src/core/auth/microsoft/oauth_callback_server.py`
...
Current compatibility implementation: `src/core/backup/instance_backup_manager.py`
...
Current compatibility implementation: `src/core/bootstrap.py`
...
Launcher settings, CurseForge gateway and policies.  
Current compatibility implementation: `src/core/config/curseforge_config_manager.py`
...
Launcher settings, CurseForge gateway and policies.  
Current compatibility implementation: `src/core/config/launcher_settings_manager.py`
...
Launcher settings, CurseForge gateway and policies.  
Current compatibility implementation: `src/core/config/managed_content_policy.py`
...
Resource packs, shader packs and Content Library.  
Current compatibility implementation: `src/core/content/content_pack_manager.py`
...
Resource packs, shader packs and Content Library.  
Current compatibility implementation: `src/core/content/content_pack_registry.py`
...
Resource packs, shader packs and Content Library.  
Current compatibility implementation: `src/core/content/installed_content_library.py`
...
CurseForge search, metadata, download and installation.  
Current compatibility implementation: `src/core/curseforge/curseforge_client.py`
...
CurseForge search, metadata, download and installation.  
Current compatibility implementation: `src/core/curseforge/curseforge_errors.py`
...
CurseForge search, metadata, download and installation.  
Current compatibility implementation: `src/core/curseforge/curseforge_manual_installer.py`
...
CurseForge search, metadata, download and installation.  
Current compatibility implementation: `src/core/curseforge/curseforge_mod_installer.py`
...
CurseForge search, metadata, download and installation.  
Current compatibility implementation: `src/core/curseforge/curseforge_pack_installer.py`
...
CurseForge search, metadata, download and installation.  
Current compatibility implementation: `src/core/curseforge/curseforge_registry.py`
...
Diagnostic reports and bundles.  
Current compatibility implementation: `src/core/diagnostics/diagnostics_manager.py`
...
Filesystem paths and data roots.  
Current compatibility implementation: `src/core/fs/paths.py`
...
FTB projects, versions and installation.  
Current compatibility implementation: `src/core/ftb/ftb_client.py`
...
FTB projects, versions and installation.  
Current compatibility implementation: `src/core/ftb/ftb_content_manager.py`
...
FTB projects, versions and installation.  
Current compatibility implementation: `src/core/ftb/ftb_pack_installer.py`
...
FTB projects, versions and installation.  
Current compatibility implementation: `src/core/ftb/ftb_pack_registry.py`
...
GPU detection and Windows preference.  
Current compatibility implementation: `src/core/hardware/gpu_preference_manager.py`
...
Instance lifecycle, status, health, journal and settings.  
Current compatibility implementation: `src/core/instance/errors.py`
...
Instance lifecycle, status, health, journal and settings.  
Current compatibility implementation: `src/core/instance/instance_health_manager.py`
...
Instance lifecycle, status, health, journal and settings.  
Current compatibility implementation: `src/core/instance/instance_manager.py`
...
Instance lifecycle, status, health, journal and settings.  
Current compatibility implementation: `src/core/instance/instance_operation_journal.py`
...
Instance lifecycle, status, health, journal and settings.  
Current compatibility implementation: `src/core/instance/instance_run_lock.py`
...
Instance lifecycle, status, health, journal and settings.  
Current compatibility implementation: `src/core/instance/settings_manager.py`
...
Java policy and metadata.  
Current compatibility implementation: `src/core/java/java_major_policy.py`
...
LAN agent and hosting.  
Current compatibility implementation: `src/core/lan/lan_agent_manager.py`
...
LAN agent and hosting.  
Current compatibility implementation: `src/core/lan/lan_hosting_manager.py`
...
Current compatibility implementation: `src/core/language/language_manager.py`
...
Current compatibility implementation: `src/core/minecraft/version_manifest_manager.py`
...
Mod files, compatibility and provenance.  
Current compatibility implementation: `src/core/mod/mod_compatibility_manager.py`
...
Mod files, compatibility and provenance.  
Current compatibility implementation: `src/core/mod/mod_manager.py`
...
Mod files, compatibility and provenance.  
Current compatibility implementation: `src/core/mod/mod_provenance_registry.py`
...
Current compatibility implementation: `src/core/modloader/fabric/fabric_meta_client.py`
...
Fabric, Quilt, Forge and NeoForge.  
Current compatibility implementation: `src/core/modloader/forge/forge_metadata_client.py`
...
Fabric, Quilt, Forge and NeoForge.  
Current compatibility implementation: `src/core/modloader/mod_loader_manager.py`
...
Fabric, Quilt, Forge and NeoForge.  
Current compatibility implementation: `src/core/modloader/neoforge/neoforge_metadata_client.py`
...
Fabric, Quilt, Forge and NeoForge.  
Current compatibility implementation: `src/core/modloader/quilt/quilt_meta_client.py`
...
Modrinth search, metadata, installation, repair and update.  
Current compatibility implementation: `src/core/modrinth/modrinth_client.py`
...
Modrinth search, metadata, installation, repair and update.  
Current compatibility implementation: `src/core/modrinth/modrinth_errors.py`
...
Modrinth search, metadata, installation, repair and update.  
Current compatibility implementation: `src/core/modrinth/modrinth_manual_installer.py`
...
Modrinth search, metadata, installation, repair and update.  
Current compatibility implementation: `src/core/modrinth/modrinth_mod_installer.py`
...
Modrinth search, metadata, installation, repair and update.  
Current compatibility implementation: `src/core/modrinth/modrinth_mod_update_manager.py`
...
Modrinth search, metadata, installation, repair and update.  
Current compatibility implementation: `src/core/modrinth/modrinth_pack_installer.py`
...
Modrinth search, metadata, installation, repair and update.  
Current compatibility implementation: `src/core/modrinth/modrinth_pack_registry.py`
...
Modrinth search, metadata, installation, repair and update.  
Current compatibility implementation: `src/core/modrinth/modrinth_pack_repair_manager.py`
...
Modrinth search, metadata, installation, repair and update.  
Current compatibility implementation: `src/core/modrinth/modrinth_pack_update_manager.py`
...
Modrinth search, metadata, installation, repair and update.  
Current compatibility implementation: `src/core/modrinth/modrinth_registry.py`
...
Downloads, bandwidth, pause/cancel and sessions.  
Current compatibility implementation: `src/core/network/download_bandwidth_limiter.py`
...
Downloads, bandwidth, pause/cancel and sessions.  
Current compatibility implementation: `src/core/network/download_manager.py`
...
Downloads, bandwidth, pause/cancel and sessions.  
Current compatibility implementation: `src/core/network/download_pause.py`
...
Downloads, bandwidth, pause/cancel and sessions.  
Current compatibility implementation: `src/core/network/network_session.py`
...
Portable content and manual files.  
Current compatibility implementation: `src/core/package/portable_content_manager.py`
...
Progress reporting.  
Current compatibility implementation: `src/core/progress/progress_reporter.py`
...
Repair scan, plan and execution.  
Current compatibility implementation: `src/core/repair/repair_service.py`
...
Current compatibility implementation: `src/core/runtime/game_runtime_manager.py`
...
Process supervision and recovery.  
Current compatibility implementation: `src/core/runtime/process_supervisor.py`
...
Process supervision and recovery.  
Current compatibility implementation: `src/core/runtime/startup_recovery_manager.py`
...
Account security and redaction.  
Current compatibility implementation: `src/core/security/account_security_manager.py`
...
Account security and redaction.  
Current compatibility implementation: `src/core/security/sensitive_data_redactor.py`
...
Current compatibility implementation: `src/core/startup_runner.py`
...
System memory.  
Current compatibility implementation: `src/core/system/memory.py`
...
Theme definitions, palette and authoring.  
Current compatibility implementation: `src/core/theme/theme_animation.py`
...
Theme definitions, palette and authoring.  
Current compatibility implementation: `src/core/theme/theme_authoring.py`
...
Theme definitions, palette and authoring.  
Current compatibility implementation: `src/core/theme/theme_font.py`
...
Theme definitions, palette and authoring.  
Current compatibility implementation: `src/core/theme/theme_manager.py`
...
Theme definitions, palette and authoring.  
Current compatibility implementation: `src/core/theme/theme_motion.py`
...
Theme definitions, palette and authoring.  
Current compatibility implementation: `src/core/theme/theme_palette.py`
...
Update discovery, download and apply.  
Current compatibility implementation: `src/core/update/update_applier.py`
...
Update discovery, download and apply.  
Current compatibility implementation: `src/core/update/update_cleanup.py`
...
Update discovery, download and apply.  
Current compatibility implementation: `src/core/update/update_manager.py`
...
Update discovery, download and apply.  
Current compatibility implementation: `src/core/update/windows_update_installer.py`
